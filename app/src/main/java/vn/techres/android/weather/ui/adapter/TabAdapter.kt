...
import vn.techres.android.weather.databinding.TabItemDesignBinding
import vn.techres.android.weather.databinding.TabItemSlidingBinding
...
class TabAdapter @JvmOverloads constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
        val bindingDesign =
            TabItemDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        val bindingSliding =
            TabItemSlidingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class SlidingViewHolder(val binding: TabItemSlidingBinding) : AppViewHolder(binding.root),
        ...
        private val mDefaultTextSize: Int by lazy {
            getResources().getDimension(vn.techres.android.weather.R.dimen.sp_14).toInt()
        }
        private val mSelectedTextSize: Int by lazy {
            getResources().getDimension(vn.techres.android.weather.R.dimen.sp_15).toInt()
        }
