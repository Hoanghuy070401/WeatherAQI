...
import vn.techres.android.weather.other.GlideEngine
...
object PhotoPickerUtils {
    ...
    private fun styleSelector(context: Context) {
        ...
        whiteTitleBarStyle.titleDrawableRightResource =
            vn.techres.android.weather.R.drawable.ic_arrow_down_orange
        whiteTitleBarStyle.titleLeftBackResource = vn.techres.android.weather.R.drawable.ic_back_gray_group
        ...
        whiteBottomNavBarStyle.bottomPreviewSelectTextColor =
            ContextCompat.getColor(context, vn.techres.android.weather.R.color.orange_700)
