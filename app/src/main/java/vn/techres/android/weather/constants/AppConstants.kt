...
AppConstants {
    ...
    const val DETAILS_LOCATION_FIND_NAME = "DETAILS_LOCATION_FIND_NAME"
    const val DETAILS_LOCATION_FIND_LAT = "DETAILS_LOCATION_FIND_LAT"
    const val DETAILS_LOCATION_FIND_LON = "DETAILS_LOCATION_FIND_LON"
