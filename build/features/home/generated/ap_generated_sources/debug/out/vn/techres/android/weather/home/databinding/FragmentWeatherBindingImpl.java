...
import vn.techres.android.weather.home.BR;
...
public class FragmentWeatherBindingImpl extends FragmentWeatherBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.Viewpager2, 1);
        sViewsWithIds.put(R.id.rlHeader, 2);
        sViewsWithIds.put(R.id.btnLocation, 3);
        sViewsWithIds.put(R.id.clViewPager2, 4);
    }
    // views
    // variables
    // values
    ...
    private FragmentWeatherBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (me.relex.circleindicator.CircleIndicator3) bindings[4]
            , (android.widget.RelativeLayout) bindings[0]
            , (android.widget.RelativeLayout) bindings[2]
            );
        this.rlBgStyle.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
