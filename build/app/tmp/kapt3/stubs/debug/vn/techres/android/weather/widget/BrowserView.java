...
public final class BrowserView extends vn.techres.widget.layout.NestedScrollWebView implements androidx.lifecycle.LifecycleEventObserver, vn.techres.base.action.ActivityAction {
    ...
    vn.techres.android.weather.widget.BrowserView.BrowserViewClient client) {
    }
    ...
    public static class BrowserChromeClient extends android.webkit.WebChromeClient {
        ...
        vn.techres.android.weather.widget.BrowserView webView) {
            super();
        }
         ...
         * 打开系统文件选择器
         */
        private final void openSystemFileChooser(vn.techres.base.BaseActivity activity, android.webkit.WebChromeClient.FileChooserParams params, android.webkit.ValueCallback<android.net.Uri[]> callback) {
        }
    }
