...
public class BasePopupWindow extends android.widget.PopupWindow implements vn.techres.base.action.ActivityAction, vn.techres.base.action.HandlerAction, vn.techres.base.action.ClickAction, vn.techres.base.action.AnimAction, vn.techres.base.action.KeyboardAction, android.widget.PopupWindow.OnDismissListener {
    ...
    vn.techres.android.weather.other.BasePopupWindow.OnShowListener listener) {
    }
    ...
    vn.techres.android.weather.other.BasePopupWindow.OnDismissListener listener) {
    }
     ...
     * 设置显示监听器集合
     */
    private final void setOnShowListeners(java.util.List<vn.techres.android.weather.other.BasePopupWindow.OnShowListener> listeners) {
    }
    
    /**
     * 设置销毁监听器集合
     */
    private final void setOnDismissListeners(java.util.List<vn.techres.android.weather.other.BasePopupWindow.OnDismissListener> listeners) {
    }
    ...
    public static class Builder<B extends vn.techres.android.weather.other.BasePopupWindow.Builder<B>> implements vn.techres.base.action.ActivityAction, vn.techres.base.action.ResourcesAction, vn.techres.base.action.ClickAction, vn.techres.base.action.KeyboardAction {
         ...
         * PopupWindow 显示监听
         */
        private final java.util.List<vn.techres.android.weather.other.BasePopupWindow.OnShowListener> getShowListeners() {
            return null;
        }
         ...
         * PopupWindow 销毁监听
         */
        private final java.util.List<vn.techres.android.weather.other.BasePopupWindow.OnDismissListener> getDismissListeners() {
            return null;
        }
        ...
        vn.techres.android.weather.other.BasePopupWindow.OnCreateListener listener) {
            return null;
        }
        ...
        vn.techres.android.weather.other.BasePopupWindow.OnClickListener<? extends android.view.View> listener) {
            return null;
        }
         ...
         */
        @org.jetbrains.annotations.NotNull
        protected vn.techres.android.weather.other.BasePopupWindow createPopupWindow(@org.jetbrains.annotations.NotNull
        android.content.Context context) {
            return null;
        }
         ...
         */
        @org.jetbrains.annotations.Nullable
        public vn.techres.android.weather.other.BasePopupWindow getPopupWindow() {
            return null;
        }
