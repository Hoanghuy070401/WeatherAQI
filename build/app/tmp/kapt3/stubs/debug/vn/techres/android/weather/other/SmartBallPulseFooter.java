...
public final class SmartBallPulseFooter extends com.scwang.smart.refresh.layout.simple.SimpleComponent implements com.scwang.smart.refresh.layout.api.RefreshFooter {
    ...
    @java.lang.Override
    public void setPrimaryColors(@androidx.annotation.ColorInt
    @org.jetbrains.annotations.NotNull
    int... colors) {
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final vn.techres.android.weather.other.SmartBallPulseFooter setSpinnerStyle(@org.jetbrains.annotations.Nullable
    com.scwang.smart.refresh.layout.constant.SpinnerStyle style) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull
    public final vn.techres.android.weather.other.SmartBallPulseFooter setNormalColor(@androidx.annotation.ColorInt
    int color) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull
    public final vn.techres.android.weather.other.SmartBallPulseFooter setAnimatingColor(@androidx.annotation.ColorInt
    int color) {
        return null;
    }
