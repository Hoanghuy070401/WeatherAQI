...
public class UpdateDialogBindingImpl extends UpdateDialogBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_update_name, 1);
        sViewsWithIds.put(R.id.tv_update_details, 2);
        sViewsWithIds.put(R.id.tv_update_close, 3);
        sViewsWithIds.put(R.id.v_ui_line, 4);
        sViewsWithIds.put(R.id.tv_update_update, 5);
    }
    // views
    @NonNull
    ...
    private UpdateDialogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (vn.techres.android.weather.widget.AppTextViewBold) bindings[3]
            , (vn.techres.android.weather.widget.AppTextView) bindings[2]
            , (vn.techres.android.weather.widget.AppTextView) bindings[1]
            , (vn.techres.android.weather.widget.AppButtonBold) bindings[5]
